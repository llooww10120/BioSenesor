...
def getsensorlist(listin):
    sensorlist = [[listin[7]   ,listin[6]   ,listin[5]   ,listin[4]   ,listin[3]   ,listin[2]   ,listin[1]   ,listin[0]   ,listin[11]  ,listin[10]]  ,
    ...
    while localtime <= time:
        ...
        if ohm:
            ...
            for i in ohm:
               listin.append(i)
            plt.title(localtime)
            plt.imshow(getsensorlist(listin),cmap="RdBu",vmax=100000,vmin=0)
